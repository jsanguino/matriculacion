...
jQuery.extend({
  ...
  dobPicker: function(params) {
    ...
    if(typeof(params.dayDefault)==='undefined') params.dayDefault = 'Día';
    if(typeof(params.monthDefault)==='undefined') params.monthDefault = 'Mes';
    if(typeof(params.yearDefault)==='undefined') params.yearDefault = 'Año';
